...
public class lab2 {
  ...
  static void printMenu() {
    System.out.println("\nMenu:");
    System.out.println("1. Click 1 to Enter a name");
    System.out.println("2. Click 2 to Search for a name");
    System.out.println("3. Click 3 to Remove a name");
    System.out.println("4. Click 4 to Exit the program");
